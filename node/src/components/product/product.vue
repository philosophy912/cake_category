<template>
  <div class="product">
    <el-form-item v-for="(formula, index) in formulas" :key="index" :label="formula.type" label-width="100px">
      <el-col :span="6">
        <el-select v-model="formula.name" placeholder="请选择" v-if="show(formula)">
      ...
      <el-col :span="8" class="buttons" style="text-align:right;">
        <el-button @click="del(index)" type="danger" size="medium" icon="el-icon-remove-outline" />
        <el-button @click="add(formula.type)" type="primary" size="medium" icon="el-icon-circle-plus-outline" />
      </el-col>
    </el-form-item>
  </div>
</template>
