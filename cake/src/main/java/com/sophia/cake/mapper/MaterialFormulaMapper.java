...
public interface MaterialFormulaMapper {
     ...
     * @return 结果
     */
    @Select("select * from T_MATERIAL_FORMULA where id =#{id}")
     ...
     * @return 结果
     */
    @Insert("insert into T_MATERIAL_FORMULA(COUNT, PRICE) VALUES (#{count}, #{price})")
     ...
     * @return 结果
     */
    @Update("update T_MATERIAL_FORMULA set MATERIAL_ID = #{materialId} where  id = #{id}")
